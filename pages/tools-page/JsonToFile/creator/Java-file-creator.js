...
* 获取文件信息
*/
WPFileInfoMetaHandler.prototype.getFileInfoArrayForJava = function() {
...
* 更新className
*/
WPFileInfoMetaHandler.prototype.updateClassNameForJava = function() {
...
*/
WPFileInfoMetaHandler.prototype.fileMetaUpdateClassNameForJava = function(fileMeta) {
...
*/
WPFileInfoMetaHandler.prototype.updateParentPropertyTypeForJava = function(fileMeta) {
...
* 更新属性类型
*/
WPFileInfoMetaHandler.prototype.fileUpdatePropertyTypeForJava = function() {
	for (var i in this.filesArray) {
		var fileMeta = this.filesArray[i];
		var propertyTextArr = [];
		for (var i in this.modelInfoMeta.propertyInfoArray) {
...
* 文件创建注释信息
*/
WPFileInfoMetaHandler.prototype.getCreatedInfoTextForJava = function(extensionName) {
...
WPFileInfoMeta.prototype.getDetailInfoForJava = function() {
...
LSModelPropertyInfoMeta.prototype.getDefineContentTextForJava = function() {
	//容器泛型
...
WPCreateFileContentForAllClassForJava = function(array) {
	var classArr = [];
	var rootFileMeta = {};
