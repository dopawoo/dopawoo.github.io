...
* 获取文件信息
*/
WPFileInfoMetaHandler.prototype.getFileInfoArrayForSwift = function() {
...
* 更新className
*/
WPFileInfoMetaHandler.prototype.updateClassNameForSwift = function() {
...
*/
WPFileInfoMetaHandler.prototype.fileMetaUpdateClassNameForSwift = function(fileMeta) {
...
*/
WPFileInfoMetaHandler.prototype.updateParentPropertyTypeForSwift = function(fileMeta) {
...
* 更新属性类型
*/
WPFileInfoMetaHandler.prototype.fileUpdatePropertyTypeForSwift = function() {
	for (var i in this.filesArray) {
		var fileMeta = this.filesArray[i];
		var propertyTextArr = [];
		for (var i in this.modelInfoMeta.propertyInfoArray) {
...
* 文件创建注释信息
*/
WPFileInfoMetaHandler.prototype.getCreatedInfoTextForSwift = function(extensionName) {
	var className = this.modelInfoMeta.className;
	var date = new Date();
...
LSModelPropertyInfoMeta.prototype.getDefineContentTextForSwift = function() {
	//容器泛型
...
WPCreateFileContentForAllClassForSwift = function(array) {
	var classArr = [];
	var rootFileMeta = {};
